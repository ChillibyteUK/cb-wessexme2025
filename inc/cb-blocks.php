    ...
    if ( function_exists( 'acf_register_block_type' ) ) {
        ...
        acf_register_block_type(
            array(
				...
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'page-templates/blocks/cb-sectors-nav.php',
        ...
        acf_register_block_type(
            array(
				...
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'page-templates/blocks/cb-services-nav.php',
        ...
        acf_register_block_type(
            array(
				...
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'page-templates/blocks/cb-accreditations.php',
        ...
        acf_register_block_type(
            array(
				...
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'page-templates/blocks/cb-testimonials.php',
        ...
        acf_register_block_type(
            array(
				...
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'page-templates/blocks/cb-client-slider.php',
				'mode'            => 'edit',
				'supports'        => array( 'mode' => false ),
            )
        );
        ...
        acf_register_block_type(
            array(
				...
				'category'        => 'layout',
				'icon'            => 'cover-image',
				'render_template' => 'page-templates/blocks/cb-latest-cs.php',
				'mode'            => 'edit',
				'supports'        => array( 'mode' => false ),
            )
        );
