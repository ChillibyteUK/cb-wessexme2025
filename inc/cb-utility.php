<?php
/**
 * Utility functions for the cb-wessexme2025 WordPress theme.
 *
...
/**
 * Split content into lines by <br>, <br/>, or <br />.
 *
...
add_shortcode(
	...
	function () {
		...
		if ( '' !== $twurl ) {
			return '<a href="' . $twurl . '" target="_blank"><i class="fa-brands fa-twitter-x"></i></a>';
		}
	}
);
add_shortcode(
