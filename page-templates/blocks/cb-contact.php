...
<div class="container-xl py-5">
    <div class="row g-4">
        <div class="col-lg-6">
            ...
            <ul class="fa-ul no-indent">
                ...
                if ( get_field( 'contact_fax', 'options' ) ?? null ) {
                    ?>
                <li class="mb-2"><span class="fa-li"><i class="fas fa-fax"></i></span> <?= wp_kses_post( get_field( 'contact_fax', 'options' ) ); ?></li>
                    <?php
                }
                ?>
            </ul>
        ...
        <div class="col-lg-6">
            <iframe src="<?= esc_url( get_field( 'google_maps_url', 'options' ) ); ?>" width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
        </div>
    </div>
</div>